...
**Why are you looking for normality for the individual variables? We only**
**need the residuals from your model to be normally distributed.**
...
**See my posts in the Research Cafe under the "score tests" thread for more**
**information. The score test does yield the same $p$ value as the other**
**tests.**
...
**Actually, it's because you used the wrong statistic. You need to use the**
**F test rather than chi square.**
...
**I don't see where you explored region. It turns out that party is the**
**only influential factor, but I can't tell how you arrived at that**
**conclusion.**
...
**What is your final model and what are the effect sizes for that model?**
...
**You should have run a linear regression on this and then looked at the**
**slope. Remember that you have taken logs, so you shouldn't expect a**
**quadratic relationship. Rather, you would have found a slope near 2, which**
**tells us that the gamma is a good model.**

***

**This is a nice project. I suggested a few improvements in my notes within.**

**Score: 85/100**

**As always, it has been a pleasure having you in the seminar. I look forward**
**to watching you continue to make progress in completing your program!**
