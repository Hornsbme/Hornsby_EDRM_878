...
**Just so you are aware, your plot is not showing confidence intervals for**
**fitted values. It may seem that way, because you used the boundaries of**
**your regression coefficients, but note that this will result in a**
**different calculation. Think, for example, of drawing a sample at random**
**and then calculating regression coefficients. At some point one sample**
**may be at the lower bound coefficient for your intercept, but it will**
**not simultaneously be a the lower bound for your slope.**
...
**Nice work! Make sure to see my one comment above.**
